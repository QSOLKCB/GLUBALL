...
# Build and run the additive GLUBALL CUDA Runtime V3 efficiency observer.
set -eu
...
BUILD_DIR=${BUILD_DIR:-build/cuda-v3}
OUTPUT=${OUTPUT:-}
...
cmake --build "$BUILD_DIR" --target gluball-cuda-runtime-v3 --parallel
